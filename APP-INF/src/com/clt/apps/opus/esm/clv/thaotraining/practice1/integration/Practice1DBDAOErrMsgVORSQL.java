...
*@FileName : Practice1DBDAOErrMsgVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 2022.10.27
*@LastModifier : 
*@LastVersion : 1.0
* 2022.10.27 
* 1.0 Creation
...
public class Practice1DBDAOErrMsgVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice1DBDAOErrMsgVORSQL(){
		setQuery();
		...
		query.append("FileName : Practice1DBDAOErrMsgVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
