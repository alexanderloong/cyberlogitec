 ...
 * @author Vi Nguyen
 * @see SinhVienEvent 참조
 * @since J2EE 1.6
 */

public class SINHVIENHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * SINHVIENHTMLAction 객체를 생성
	 */
	public SINHVIENHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		SinhvienEvent event = new SinhvienEvent();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			event.setSinhVienVO((SinhVienVO)getVO(request, SinhVienVO .class,""));
//			System.out.println(request);
//			SinhVienVO sinhVienVO = new SinhVienVO();
//			sinhVienVO.setTen(JSPUtil.getParameter(request, "s_ten", ""));
//			sinhVienVO.setTuoi(JSPUtil.getParameter(request, "s_tuoi", ""));
