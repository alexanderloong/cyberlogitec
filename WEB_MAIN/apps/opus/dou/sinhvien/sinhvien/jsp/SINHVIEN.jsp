...
<%
	...
	try {
		...
		khoaHoc = eventResponse.getETCData("khoaHocs");
...
<div class="page_title_area clear">
		    ...
		    <table>
				...
				<tr>
					<th width="40">Courses</th>
						<td width="120"><script type="text/javascript">ComComboObject('s_khoahoc',1,80, 1, 0, 0);</script></td>
				   <th width="40">Name</th>
				<td width="120"><input type="text" style="width:100px;" class="input" value="" name="ten" id="ten"></td>
				<th width="40">Age</th>
				<td><input type="number" min=0 style="width:100px;" class="input" value="" name="tuoi" id="tuoi"></td>
				</tr> 
				</tbody>
			</table>
		</div>
	...
	<div class="opus_design_tab">
		...
		<div class="opus_design_grid clear" name="tabLayer" id="tabLayer">
			<h3 class="title_design">Muon Sach</h3>
